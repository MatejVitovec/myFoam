...
#include "gyarmathyMixtureGrowthModel.H"
...
namespace WetSteam
{    
    defineTypeNameAndDebug(gyarmathyMixtureGrowthModel, 0);
    addToRunTimeSelectionTable(growthModel, gyarmathyMixtureGrowthModel, dictionary);
}
}
...
Foam::WetSteam::gyarmathyMixtureGrowthModel::gyarmathyMixtureGrowthModel
(
...
Foam::tmp<Foam::volScalarField> Foam::WetSteam::gyarmathyMixtureGrowthModel::knudsenNumber(const volScalarField& r) const
{
